        ...
        <div class="col-6 my-5">
            ...
            <form action="<?php echo ($_SERVER["PHP_SELF"]);?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Enter password" id="pwd" name="p_password">
                </div>
                <div class="form-group">
                <label for="name">age:</label>
                    <input type="text" class="form-control" placeholder="Enter address" id="email" name="p_age">
                </div>
