...
<body>
  ...
  <div class="container">
    ...
    <form action="<?php echo ($_SERVER["PHP_SELF"]);?>" method="post">
      <div class="field">
        <label>Name</label>
        <input type="text" placeholder="Party" name="e_name">
      </div>
      ...
      <div class="field">
        ...
        <textarea placeholder="Fantastic party where you can have a lot of fun with a lot of people and drinks" name="e_desc"></textarea>
      </div>
