...
";
    ...
    <form action="deir-al-zorr.php?id=<?php echo $id; ?>" method="post">
            <div class="form-group">
                <label for="eventServices">place:</label>
                <select id="eventServices" name="e_place" required>
                    <option value="ta3lelah-rushdia">ta3lelah=rushdia</option>
                    <option value="al nakheel-korneesh">al nakhil-korneesh</option>
                    <option value="ayam zaman-haweeqa">ayam zaman-haweeqa</option>
                </select>
            </div>
            <div class="form-group">
